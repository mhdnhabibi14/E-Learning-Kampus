            ...
            <div class="modal-content">
                ...
                <form action="{{ $action }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="formMataKuliahLabel{{ $uniqueId }}">
                            Form Mata Kuliah
                        </h1>
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Kode Mata Kuliah --}}
                        <div class="form-group mb-2">
                            <label for="kode_mata_kuliah_{{ $uniqueId }}" class="form-label">
                                Kode Mata Kuliah
                            </label>
                        ...
                        {{-- Nama Mata Kuliah --}}
                        <div class="form-group mb-2">
                            <label for="nama_mata_kuliah_{{ $uniqueId }}" class="form-label">
                                Nama Mata Kuliah
                            </label>
                        ...
                        {{-- SKS --}}
                        <div class="form-group mb-2">
                            <label for="sks_{{ $uniqueId }}" class="form-label">
                                SKS
                            </label>
                        ...
                        {{-- Semester --}}
                        <div class="form-group mb-2">
                            <label for="semester_{{ $uniqueId }}" class="form-label">
                                Semester
                            </label>
                            ...
                            <select class="form-select" id="semester_{{ $uniqueId }}" name="semester">
                                ...
                                @for ($i = 1; $i <= 14; $i++)
                                    <option value="{{ $i }}"
                                        {{ ($useOld ? old('semester') : $semester) == $i ? 'selected' : '' }}>
                                        Semester {{ $i }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        {{-- Status --}}
                        <div class="form-group mb-2">
                            <label for="is_active_{{ $uniqueId }}" class="form-label">
                                Status
                            </label>
